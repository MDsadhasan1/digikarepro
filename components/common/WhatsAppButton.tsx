...
export default function WhatsAppButton() {
  ...
  const handleClick = () => {
    const phone = formatPhoneForWhatsApp(WHATSAPP_NUMBER);
  ...
  return (
    <button
      ...
      className="fab w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] text-white
                 bottom-6 right-6 shadow-lg shadow-[#25D366]/40"
    >
